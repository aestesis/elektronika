...
AppVerName=Aestesis Elektronika Live 2.51
...
Source: movies\bw-machine-01_qt.mov; DestDir: {app}\movies
Source: movies\bw-machine-02_qt.mov; DestDir: {app}\movies
Source: movies\bw-machine-03_qt.mov; DestDir: {app}\movies
Source: movies\bw-machine-04_qt.mov; DestDir: {app}\movies

; movie-loops
Source: movies\vstudio-loops\*; DestDir: {app}\movies\vstudio-loops; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: dotnetfx.exe; DestDir: {tmp}
...
Source: dx\BDA.cab; DestDir: {tmp}
Source: dx\BDANT.cab; DestDir: {tmp}
Source: dx\BDAXP.cab; DestDir: {tmp}
Source: dx\DirectX.cab; DestDir: {tmp}
Source: dx\dsetup32.dll; DestDir: {tmp}
Source: dx\DSETUP.dll; DestDir: {tmp}
Source: dx\dxnt.cab; DestDir: {tmp}
Source: dx\dxsetup.exe; DestDir: {tmp}
Source: dx\ManagedDX.CAB; DestDir: {tmp}
Source: dx\dxdllreg_x86.cab; DestDir: {tmp}
Source: dx\dxupdate.cab; DestDir: {tmp}
Source: dx\Oct2005_MDX_x86.cab; DestDir: {tmp}
Source: dx\Oct2005_xinput_x64.cab; DestDir: {tmp}
Source: dx\Oct2005_xinput_x86.cab; DestDir: {tmp}
Source: dx\Aug2005_d3dx9_27_x64.cab; DestDir: {tmp}
Source: dx\Aug2005_d3dx9_27_x86.cab; DestDir: {tmp}
...
; auto start
Name: {commonstartup}\elektronika; Filename: {app}\elektronika.exe;
...
Filename: {tmp}\dotnetfx.exe; WorkingDir: {tmp}; Parameters: /Q
...
Filename: {tmp}\dxsetup.exe; WorkingDir: {tmp}
