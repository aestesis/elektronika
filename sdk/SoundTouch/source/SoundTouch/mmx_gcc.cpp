 ...
 *
 * Last changed  : $Date: 2003/11/17 17:56:23 $
 * File revision : $Revision: 1.9 $
 *
 * $Id: mmx_gcc.cpp,v 1.9 2003/11/17 17:56:23 Olli Exp $
 *
 * Acknowledgements:
...
inline int TDStretchMMX::calculateCrossCorrelation(const short *pV1, const short *pV2) const
{
#ifdef __i386__
    int corr;
