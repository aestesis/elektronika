...
#if defined(_MPPC_) || defined(GENERATOR)
// JLG we want to use Float on Win32 and PPC, integer otherwise
// assume server hardware will have a CPU with floating point support
...
// Support progressive in the generator
